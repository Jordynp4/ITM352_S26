...
print(f"The homes data has {shape[0]} and {shape[1]} columns.")
...
# Print out fist 10 rows after cleansing
...
print(f"the mean sale price for big properties is ${average_price:.2f}")